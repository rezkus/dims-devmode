...
echo
curl -s -X GET http://localhost:4000/channels/mychannel/transactions/568fc09717dce5b0fe129cf6585773a88e2a118b021d4dd7c5334005c51e55b8?peer=peer1.org2.example.com \
